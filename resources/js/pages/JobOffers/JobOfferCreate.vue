        ...
        <form v-if="showForm && canCreateJobOffer" class="mx-4 p-4 bg-white rounded-lg shadow-md dark:bg-gray-800 mb-6"
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <label for="form_title"
                       class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Pozíció
                    neve</label>
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <label for="form_location"
                       class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Helyszín</label>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input id="form_salary_min" v-model="form.salary_min" type="number" min="0" placeholder=" " required
                           step="10000"
                           class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer"/>
                    <label for="form_salary_min"
                           class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Min.
                        fizetés (Ft)</label>
                    <p v-if="errors.salary_min" class="text-red-500 text-xs mt-1">{{ errors.salary_min[0] }}</p>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input id="form_salary_max" v-model="form.salary_max" type="number" min="0" placeholder=" " required
                           step="10000"
                           class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer"/>
                    <label for="form_salary_max"
                           class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Max.
                        fizetés (Ft)</label>
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <label for="form_description"
                       class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Leírás</label>
        ...
        <div class="mx-4 p-4">
            <table class="w-full text-sm text-left">
                ...
                <tr v-for="offer in jobOffers" :key="offer.id" class="border-b border-gray-100">
                    ...
                    <td class="py-2 pr-4">{{
                            workModes.find(m => m.value === offer.work_mode)?.label ?? offer.work_mode
                        }}
                    </td>
                    <td class="py-2 pr-4">{{ offer.salary_min.toLocaleString() }} – {{
                            offer.salary_max.toLocaleString()
                        }}
                    </td>
                    <td class="py-2">
