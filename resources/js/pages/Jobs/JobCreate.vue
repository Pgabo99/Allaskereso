...
<template>
    <div class="max-w-md mx-auto">
        ...
        <form class="max-w-md mx-auto p-4 bg-white rounded-lg shadow-md dark:bg-gray-800"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input id="floating_title"
                       class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer"
                       name="floating_title" placeholder=" " required type="text" v-model="form.title"/>
                <label
                    ...
                    for="floating_title">Munkaneve</label>
