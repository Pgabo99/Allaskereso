...
const startEdit = (company: Company) => {
    ...
    editForm.value = { name: company.name, contact_email: company.contact_email, location: company.location, tax_id: company.tax_id };
    editErrors.value = {};
    showForm.value = false;
};
...
<template>
    <div class="max-w-5xl mx-auto">
        ...
        <form v-if="editingCompany" class="mx-4 p-4 bg-white rounded-lg shadow-md dark:bg-gray-800 mb-6" @submit.prevent="submitEdit">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input id="edit_name" v-model="editForm.name" type="text" placeholder=" " required
                    class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" />
                <label for="edit_name" class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Cég neve</label>
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input id="edit_contact_email" v-model="editForm.contact_email" type="email" placeholder=" " required
                    class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" />
                <label for="edit_contact_email" class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Kapcsolattartó email</label>
                <p v-if="editErrors.contact_email" class="text-red-500 text-xs mt-1">{{ editErrors.contact_email[0] }}</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input id="edit_location" v-model="editForm.location" type="text" placeholder=" " required
                        class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" />
                    <label for="edit_location" class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Székhely</label>
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input id="edit_tax_id" v-model="editForm.tax_id" type="text" placeholder=" " required
                        class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" />
                    <label for="edit_tax_id" class="absolute text-sm text-body duration-300 transform -translate-y-6 scale-75 top-3 -z-10 peer-focus:z-10 peer-[&:not(:placeholder-shown)]:z-10 origin-[0] peer-focus:start-0 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Adószám</label>
                        ...
                        <td class="py-2">
                            <div class="flex gap-2">
                                <router-link :to="`/company/${company.id}/employees`" title="Alkalmazottak"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a4 4 0 00-5-3.87M9 20H4v-2a4 4 0 015-3.87m6-4a4 4 0 11-8 0 4 4 0 018 0zm6-4a3 3 0 11-6 0 3 3 0 016 0zM3 8a3 3 0 116 0A3 3 0 013 8z"/></svg>
                                </router-link>
